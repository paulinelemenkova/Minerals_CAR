...
At the same time, the comparisons of the magnetic contrasts, geologic setting and geophysical data provide new insights into the formation of the continental margins in the Earth critical zones. It furthermore enables to perform a better interpretation the effects of the tectonic processes in the past on the mineral distribution of resources in the present \cite{FELIXTOTEU2002906}. Thus, regions affected by significant geodynamic processes in the past are notable for negative magnetic anomalies, which suggests a strong correlation between the active tectonics in the past and the origin of the magnetic anomalies associated with the lithosphere movements \cite{RAVAT199259}. For instance, \cite{ARKANIHAMED1985257} noted that lithosphere beneath the sedimentary basins formed during the Gondwana break up have a lower geomagnetism compared to the regions under the cratons, which is related to the thermal demagnetisation of the high-temperature asthenosphere. Further, certain effects are noted from the magnetic mineralogy of the ascending magma in the lower crust.
...
\centering
	...
	\caption{Topographic map of Central African Republic. Mapping software: Generic Mapping Tools (GMT) scripting toolset version 6.1.1, \cite{Wessel}. Data source: GEBCO/SRTM \cite{GEBCO,SRTM}. Cartography: authors.
	\label{fig01}}
\end{figure}
...
\centering
	...
	\caption{Derivative of the IGPP Earth’s gravity field on Central African Republic: vertical gravity gradient. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EGM2008 Global Earth Geoid \cite{SANDWELL20211059}. Cartography source: authors.
	\label{fig07}}
\end{figure}
