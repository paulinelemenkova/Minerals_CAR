...
\centering
	...
	\caption{Earth geoid map of Central African Republic. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EGM2008 Global Earth Geoid. Cartography source: authors.
	\label{fig01}}
\end{figure}
...
\centering
	...
	\caption{IGPP Earth Free-Air Anomaly on Central African Republic. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EGM2008 Global Earth Geoid. Cartography source: authors.
	\label{fig01}}
\end{figure}
...
\centering
	...
	\caption{Map of magnetic anomaly in CAR. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EMAG2. Cartography source: authors. Note: black and dark grey areas mean the "no data" areas where no magnetic survey was done in the original dataset.
	\label{fig01}}
\end{figure}
