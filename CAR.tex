...
The Paleozoic (Pz) period is notable for emergence and geomorphic erosion of earlier reliefs which resulted in the upper hilly surface of argillites in the north \cite{Boulvert1995}. The basin of the Aouk river and its tributaries, forming a natural border between CAR and Chad is presented by the alluvium and colluvium from the Pleistocene (Qp) valleys with modern sediments of Holocene (Qe), Figure \ref{fig03}. The formations in the alluvial deposits also include notable intrusions of diamonds formed as a result of the ascent of the upper mantle and related magmatic processes during the geological history of CAR \cite{Censieretal1998,Censier,MALPELI2014249,berthoumieux1957mission}. The extensive diamond deposits are mostly distributed in the south-western region and north-easter regions of the country in the the Carnot and Mouka-Ouadda Sandstone formations \cite{MALPELI2014249,USGSreport}.
