...
\abstract{
Interactions between geophysical processes and geodynamics of lithosphere play a crucial role in geologic structure of the Earth's crust. The Bangui magnetic anomaly is a notable feature in the lithospheric structure of Central African Republic (CAR) resulted from complex tectonic evolution of central African region. We present a series of the GMT-based maps to obtain the coherence in the geophysical data and magnetic anomaly field from integration of free-air altimetric gravity, magnetic EMAG2 Earth data, geoid EGM2008 model and topographic SRTM/ETOPO1 relief to get insights in the geodynamics of CAR region. Histogram equalization of the topographic grids was performed for partition of grid file into equal-area patches of data ranged into segments with relative highs and lows of the relief, and to compare the original data with equalized, normalized and quadratic models. The consistency and equalization of topography, gravity and geoid data was based using GMT modules grdfft and grdhisteq modules. On the presented maps, we demonstrated the correlation between the distribution of rocks with high magnetism in the central part of the anomaly, geologic fields of granites, greenstone belts, and metamorphosed basalts as rock exposures, negative Bouguer anomaly (<−80 mGal), low geoid values (< -12 m) and the elongated shape of the magnetic anomaly with extreme negative values ranging within the amplitude of –1000 to –200 nT. The fusion of multi-source datasets in the reported work provides a new insight into the analyses of crustal thicknesses and the average density of the Earth in CAR, as well as magnitude of the magnetic fields with notable deviations caused by magnetic flux density in Bangui area related to the distribution of mineral resources.}
...
gmt psbasemap -R -J -Lx13.5c/-2.3c+c50+w300k+l"Mercator projection. Scale: km"+f \
    -UBL/-0p/-70p -O -K >> $ps
...
\centering
	...
	\caption{Earth geoid map of Central African Republic. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EGM2008 Global Earth Geoid \cite{Pavlis}. Cartography source: authors.
	\label{fig01}}
\end{figure}
...
\centering
	...
	\caption{Map of magnetic anomaly in CAR. Mapping software: GMT v. 6.1.1, \cite{Wessel}. Data source: EMAG2 \cite{Meyer}. Cartography source: authors. Note: black and dark grey areas mean the "no data" areas where no magnetic survey was done in the original dataset.
	\label{fig01}}
\end{figure}
