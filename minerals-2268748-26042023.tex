...
%}
	...
	\caption{Histogram equalisation of the topography grids on CAR based on the ETOPO1 raster data. \textbf{(a)} ; \textbf{(b)} ; \textbf{(c)} ; \textbf{(d)} . Data source: \hl{ETOPO1}. %MDPI: please label these sub-figures with a,b,c,d and give an explanation for them.
	\label{fig04}}
\end{figure}
\vspace{-9pt}
